...
// Fetch all cancelled orders with their items
...
<head>
    ...
    <style>
        ...
        .order-card {
            ...
            margin-bottom: 18px;
            overflow: hidden;
            opacity: 0.85; /* Slightly dimmed to visually indicate cancelled */
        }
        ...
        .order-product-img {
            ...
            flex-shrink: 0;
            filter: grayscale(30%); /* Subtle desaturation for cancelled items */
        }
