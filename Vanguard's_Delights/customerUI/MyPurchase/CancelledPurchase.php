...
try {
    ...
    $ordersStmt = $conn->prepare("
        ...
        WHERE o.user_id = ? AND TRIM(o.order_status) = 'Cancelled'
...
<title>Cancelled Purchases | Vanguard's Delights</title>
...
.cancelled-badge { color: #dc3545; font-weight: 700; font-size: 0.95rem; }
        ...
        <div class="account-container">
            ...
            <div class="account-main-content">
                ...
                <div class="tabs-row">
                    ...
                    <a href="CancelledPurchase.php" class="tab-btn active">Cancelled</a>
                </div>
                        ...
                        <div class="order-card">
                            ...
                            <?php foreach ($order['items'] as $item): ?>
                                <div class="row align-items-center mb-3">
                                    <div class="col-auto">
                                        <img src="<?= htmlspecialchars($item['image_url'] ?: '../../images/placeholder.png') ?>" class="product-img">
                                    </div>
                                    <div class="col">
