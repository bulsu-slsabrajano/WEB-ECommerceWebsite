...
.nav-item-link{ display:flex; gap:12px; padding:15px 30px; color:rgba(255,255,255,.8); text-decoration:none; }
...
.total-price{ font-weight:700; }
.completed-badge{ color:#198754; font-weight:bold; }
</style>
</head>
                        ...
                        <div class="order-card">
                            ...
                            <div class="d-flex justify-content-end align-items-center border-top pt-3 mt-2">
                                <div class="text-end">
                                    ...
                                    <span class="fw-bold fs-5" style="color:#7A2E2E;">
